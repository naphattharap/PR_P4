function [varargout]=gscatter3(x,y,z,g,s)
%------------------------------HELP START----------------------------------
...
for i=1:length(gu),
    ...
    if ~iscellstr(clr)&&~ischar(clr),
        set(h(1,i),'LineStyle','none','Color',clr(i,:),'Marker','o','MarkerSize',s,'MarkerFaceColor',mrkfclr(i,:));
    else
        set(h(1,i),'LineStyle','none','Color',clr{1,i},'Marker','o','MarkerSize',s,'MarkerFaceColor',mrkfclr{1,i});
    end;
end;
